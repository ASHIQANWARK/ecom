...
const Contact = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-[#FFAB00] to-[#FFD500] overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            <div className="flex items-center p-6 rounded-xl shadow-xl bg-white bg-opacity-40 backdrop-blur-md">
              ...
              <div>
                ...
                <p className="text-lg">WWW.LAUNCHYOURECOMMERCE.COM</p>
              </div>
            </div>
            <div className="flex items-center p-6 rounded-xl shadow-xl bg-white bg-opacity-40 backdrop-blur-md">
              <div className="text-3xl text-yellow-500 mr-4">
              ...
              <div>
                ...
                <p className="text-lg">+91-800-555-ECOM</p>
              </div>
            </div>
            <div className="flex items-center p-6 rounded-xl shadow-xl bg-white bg-opacity-40 backdrop-blur-md">
              <div className="text-3xl text-yellow-500 mr-4">
              ...
              <div>
                ...
                <p className="text-lg">support@lyecom.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-xl bg-opacity-80 backdrop-blur-md">
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-xl bg-yellow-500 text-white text-lg font-semibold hover:bg-yellow-600 transition-colors"
              >
                Send Message
              </button>
            </form>
